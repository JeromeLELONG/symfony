...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/(en|fr|de|es|cs|nl|ru|uk|ro|pt_BR|pl|it|ja|id|ca|sl|hr|zh_CN|bg)/admin'), array(0 => 'ROLE_ADMIN'), NULL);
