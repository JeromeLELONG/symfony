...
return $this->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Command\\AddUserCommand' => function (): \App\Command\AddUserCommand {
    return ($this->privates['App\Command\AddUserCommand'] ?? $this->load('getAddUserCommandService.php'));
}, 'App\\Command\\DeleteUserCommand' => function (): \App\Command\DeleteUserCommand {
    return ($this->privates['App\Command\DeleteUserCommand'] ?? $this->load('getDeleteUserCommandService.php'));
}, 'App\\Command\\ListUsersCommand' => function (): \App\Command\ListUsersCommand {
    return ($this->privates['App\Command\ListUsersCommand'] ?? $this->load('getListUsersCommandService.php'));
}, 'SensioLabs\\Security\\Command\\SecurityCheckerCommand' => function (): \SensioLabs\Security\Command\SecurityCheckerCommand {
