...
class srcDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once $this->targetDirs[3].'/src/EventSubscriber/RedirectToPreferredLocaleSubscriber.php';
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \App\Twig\AppExtension(new \App\Utils\Markdown(), 'en|fr|de|es|cs|nl|ru|uk|ro|pt_BR|pl|it|ja|id|ca|sl|hr|zh_CN|bg'));
    ...
    {
        return $this->privates['App\EventSubscriber\RedirectToPreferredLocaleSubscriber'] = new \App\EventSubscriber\RedirectToPreferredLocaleSubscriber(($this->services['router'] ?? $this->getRouterService()), 'en|fr|de|es|cs|nl|ru|uk|ro|pt_BR|pl|it|ja|id|ca|sl|hr|zh_CN|bg', 'en');
    }
