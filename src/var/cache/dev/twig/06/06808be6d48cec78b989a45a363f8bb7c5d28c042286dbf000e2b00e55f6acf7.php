...
class __TwigTemplate_cf65f44a5e09b34b9f778b8b462018a58a04d5568e794bfd564f5e741fdc6fa7 extends Twig_Template
{
    private $source;
...
";
    ...
    <p id=\"<?php echo \$view->escape(\$id); ?>_help\" class=\"help-text\"><?php echo \$view->escape(false !== \$translation_domain ? \$view['translator']->trans(\$help, array(), \$translation_domain) : \$help); ?></p>
<?php endif; ?>
", "@Framework/Form/form_help.html.php", "/var/www/html/appli/vendor/symfony/framework-bundle/Resources/views/Form/form_help.html.php");
    }
}
